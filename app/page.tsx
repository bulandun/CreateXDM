      ...
      <section className="mx-auto w-full max-w-[1500px] px-6 pb-14 pt-10 md:px-12 lg:pt-14">
        <Reveal>
          <div className="relative min-h-[70vh] overflow-hidden rounded-[2rem] border border-white/15 bg-[#111111] p-8 md:p-12">
            ...
            <div className="absolute right-[10%] top-[18%] h-56 w-56 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(242,225,210,0.95),rgba(183,108,66,0.62)_40%,rgba(78,103,123,0.4)_78%,rgba(12,18,24,0)_100%)] opacity-75 blur-[10px]" />
